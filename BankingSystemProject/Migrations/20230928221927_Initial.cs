        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromCurrencyCode = table.Column<int>(type: "int", nullable: false),
                    ToCurrencyCode = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyCode = table.Column<int>(type: "int", nullable: false),
                    SenderBankAccountIBAN = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReceiverBankAccountIBAN = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TransactionCreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommisionAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CurrencyCode = table.Column<int>(type: "int", nullable: false),
                    WithdrawalCreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
